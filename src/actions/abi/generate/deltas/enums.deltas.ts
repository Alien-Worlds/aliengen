...
export const generateDeltaEnums = (
    ...
    const enumsContent = TemplateEngine.GenerateTemplateOutput(Templates.Deltas.enumsTemplate, {
        contract,
        deltas,
    });
...
const createOutput = (enumsOutput: string, outputBaseDir: string): GeneratedOutput[] => {
