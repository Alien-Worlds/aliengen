...
export const typesMap = new Map<string, MappedType>([
  ...
  ["int64", { typescript: ["number"], mongo: ["number"] }],
  ["int128", { typescript: ["number"], mongo: ["number"] }],
  ["int256", { typescript: ["number"], mongo: ["number"] }],
  ["int8_t", { typescript: ["number"], mongo: ["number"] }],
  ["int16_t", { typescript: ["number"], mongo: ["number"] }],
  ["int32_t", { typescript: ["number"], mongo: ["number"] }],
  ["int64_t", { typescript: ["number"], mongo: ["number"] }],
  ["int128_t", { typescript: ["number"], mongo: ["number"] }],
  ["int256_t", { typescript: ["number"], mongo: ["number"] }],
  ["uint8", { typescript: ["number"], mongo: ["number"] }],
  ["uint16", { typescript: ["number"], mongo: ["number"] }],
  ["uint32", { typescript: ["number"], mongo: ["number"] }],
  ["uint64", { typescript: ["number"], mongo: ["number"] }],
  ["uint128", { typescript: ["number"], mongo: ["number"] }],
  ["uint256", { typescript: ["number"], mongo: ["number"] }],
  ["uint8_t", { typescript: ["number"], mongo: ["number"] }],
  ["uint16_t", { typescript: ["number"], mongo: ["number"] }],
  ["uint32_t", { typescript: ["number"], mongo: ["number"] }],
  ["uint64_t", { typescript: ["number"], mongo: ["number"] }],
  ["uint128_t", { typescript: ["number"], mongo: ["number"] }],
  ["uint256_t", { typescript: ["number"], mongo: ["number"] }],
